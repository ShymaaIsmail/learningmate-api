"""
Django settings for learningmateapi project.
...
def get_base_url(request):
    ...
    base_url = f"https://{current_host}/learningmate-api/"
    return base_url
...
ROOT_URLCONF = 'learningmateapi.urls'
...
WSGI_APPLICATION = 'learningmateapi.wsgi.application'
...
AUTH_USER_MODEL = 'learningmateapi.User'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        'learningmateapi.permissions.AllowUnauthenticatedForSomeAPIs',
    ],
}
